<x-admin-layout>
    <div class="w-full mt-12">
        ...
        <div class="mt-4 mb-4">
            <a href="{{ route('penilaian_kinerja.create') }}" class="bg-green-500 hover:bg-green-700 text-white left-0 font-light py-2 px-4 rounded">Tambah</a>
            </div>
                ...
                <tbody class="text-gray-700">
                    ...
                    @foreach ($penilaian_kinerja as $pk)
                        <tr>
                            ...
                            <td class="text-left py-3 px-4">{{ $pk->pegawai }}</td>
