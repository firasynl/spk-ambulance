        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <p class="text-2xl pb-6 flex items-center">
                    <i class="fas fa-list mr-3"></i> Edit Data Pegawai
                </p>
                        ...
                        <div class="leading-loose">
                            <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{ route('pegawai.update', $pegawai->id) }}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="rounded text-m py-1 px-2 text-black w-[700px]  border-1 border-black" name="jabatan_pegawai" id="jabatan_pegawai" value="{{ $pegawai->jabatan_pegawai }}" aria-label="Default select example">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="rounded text-m py-1 px-2 text-black w-[700px]  border-1 border-black" name="unit_kerja_pegawai" id="unit_kerja_pegawai" value="{{ $pegawai->unit_kerja_pegawai }}" aria-label="Default select example">
