                        ...
                        <div class="leading-loose">
                            <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{ route('pegawai.update', $pegawai->id) }}">
                                ...
                                <div class="">
                                    ...
                                    <select class="rounded text-sm py-1 px-2 text-black w-[700px]  border-1 border-black" name="jabatan_pegawai" id="jabatan_pegawai" value="{{ $pegawai->jabatan_pegawai }}" aria-label="Default select example">
                                ...
                                <div class="">
                                    ...
                                    <select class="rounded text-sm py-1 px-2 text-black w-[700px]  border-1 border-black" name="unit_kerja_pegawai" id="unit_kerja_pegawai" value="{{ $pegawai->unit_kerja_pegawai }}" aria-label="Default select example">
