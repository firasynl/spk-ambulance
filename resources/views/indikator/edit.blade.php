    ...
    <div class="bg-white overflow-auto">
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                <h1 class="w-full text-3xl text-black pb-6">Edit Data Indikator</h1>
                        ...
                        <div class="leading-loose">
                            <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{ route('indikator.update', $indikator->id) }}">
                                ...
                                <div class="">
                                    ...
                                    <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="indikator" name="indikator" type="text" required="" value="{{ $indikator -> indikator }}" aria-label="Indikator">
                                </div>
                                <div class="">
