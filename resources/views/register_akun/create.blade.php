                        ...
                        <div class="leading-loose">
                            <form class="p-10 bg-white rounded shadow-xl" method="POST" action="{{ route('register_akun.store') }}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="nip" name="nip" type="text" placeholder="Masukkan NIP" aria-label="NIP">
                                </div>
                                <div class="mb-2">
                                    <label class="block text-m text-gray-600" for="pangkat">Pangkat</label>
                                    <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="pangkat" name="pangkat" type="text" placeholder="Masukkan pangkat/gol.ruang" aria-label="Pangkat">
                                </div>
                                <div class="mb-2">
