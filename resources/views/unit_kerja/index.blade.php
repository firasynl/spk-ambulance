<x-admin-layout>
    <div class="w-full mt-12">
                    ...
                    <div class="mt-4 mb-4">
                    <a href="/home/unit_kerja/create" class="bg-green-500 hover:bg-green-700 text-white left-0 font-light py-2 px-4 rounded">Tambah</a>
                    </div>
                        ...
                        <table class="min-w-full bg-white">
                            <thead class="bg-gray-800 text-white">
                                <tr>
                                    ...
                                    <th class="w-1/3 text-left py-3 px-4 uppercase font-semibold text-sm">Unit Kerja</th>
                            ...
                            <tbody class="text-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="w-1/3 text-left py-3 px-4">{{$value->unit_kerja}}</td>
