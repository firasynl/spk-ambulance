...
return new class extends Migration
{
    ...
    {
        Schema::create('spk_driver', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedInteger('penilaian_12')->unsigned()->min(0)->max(100);
            $table->unsignedInteger('penilaian_13')->unsigned()->min(0)->max(100);
            $table->unsignedInteger('penilaian_14')->unsigned()->min(0)->max(100);
            $table->unsignedInteger('penilaian_15')->unsigned()->min(0)->max(100);
            $table->unsignedInteger('penilaian_16')->unsigned()->min(0)->max(100);
            $table->unsignedInteger('penilaian_17')->unsigned()->min(0)->max(100);
    ...
    {
        Schema::dropIfExists('spk_driver');
    }
};
